...
export const StatCard = ({ label, value, trend, description }: StatCardProps): JSX.Element => {
  ...
  return (
    <div className="flex flex-col rounded-3xl border border-white/60 bg-white p-6 shadow">
